...
# Getting started
1. Open the tutorial notebook in Colab using the following link: [Cognitive Models of Behavior Notebook](https://colab.research.google.com/github/kevin-j-miller/Cog_Modeling_Classic_Deep_Tutorial/blob/main/Cognitive_Models_of_Behavior.ipynb)
3. You should be able to view this notebook, but will not be able to edit it. So the first thing you should do is make a copy (File -> Save a copy in Drive), which you will be able to edit.  
4. You will need to connect your colab to a cloud-based backend in order to run it (Connect button in the top right -> Connect to a hosted runtime). We strongly recommend a runtime with either a GPU (good) or a TPU (better). 
